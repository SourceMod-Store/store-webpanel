...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Redeem your Store Code</title>
        ...
        <div class="rain">
            <div class="border start">
                <form action="<?php echo base_url("/index.php/pub/redeem_process"); ?>" method="post" accept-charset="ISO-8859-1">
                    ...
                    <input id="steamid" name="steamid" type="text" placeholder="STEAM_0:1:0000000"/>
                    <label for="code">Redeem Code</label>
                    <input name="code" type="text" placeholder="Redeem Code"/>
