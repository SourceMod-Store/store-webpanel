...
//		$this->form_validation->set_rules('phone1', $this->lang->line('edit_user_validation_phone1_label'), 'xss_clean');
//		$this->form_validation->set_rules('phone2', $this->lang->line('edit_user_validation_phone2_label'), 'xss_clean');
//		$this->form_validation->set_rules('phone3', $this->lang->line('edit_user_validation_phone3_label'), 'xss_clean');
...
//		);
	...
	function _render_page($view, $data=null, $render=false)
	{
		...
		$this->viewdata = (empty($data)) ? $this->data: $data;
                $this->viewdata["page"] = "Auth";
                
		$view_html = $this->load->view("parts/header", $this->viewdata, $render).$this->load->view($view, $this->viewdata, $render).$this->load->view("parts/footer", $this->viewdata, $render);
